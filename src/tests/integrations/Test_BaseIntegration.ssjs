...
try {
    ...
    try {
        ...
        var base1 = new BaseIntegration(response1, connection1, 'TestIntegration', {
            // Missing baseUrl
        }, null);
    ...
    try {
        ...
        var base2 = new BaseIntegration(response2, connection2, 'TestIntegration', {
    ...
    try {
        ...
        var base3 = new BaseIntegration(response3, connection3, 'TestIntegration', {
            baseUrl: 'https://api.example.com'
        }, null);

        var authStrategy = OmegaFramework.require('BasicAuthStrategy', {
            username: 'test',
            password: 'test123'
        });
    ...
    try {
        ...
        var base4 = new BaseIntegration(response4, connection4, 'TestIntegration', {
            baseUrl: 'https://api.example.com'
        }, null);

        var authStrategy4 = OmegaFramework.require('BasicAuthStrategy', {
            username: 'testuser',
            password: 'testpass'
        });
    ...
    try {
        ...
        var base5 = new BaseIntegration(response5, connection5, 'TestIntegration', {
            baseUrl: 'https://api.example.com'
        }, null);
    ...
    try {
        ...
        var base6 = new BaseIntegration(response6, connection6, 'TestIntegration', {
            baseUrl: 'https://api.example.com/'
        }, null);
    ...
    try {
        ...
        var base7 = new BaseIntegration(response7, connection7, 'TestIntegration', {
            baseUrl: 'https://api.example.com'
        }, null);
    ...
    try {
        var response8 = OmegaFramework.require('ResponseWrapper', {});
        var connection8 = OmegaFramework.require('ConnectionHandler', {});

        var base8 = new BaseIntegration(response8, connection8, 'TestIntegration', {
            baseUrl: 'https://api.example.com'
        }, null);
